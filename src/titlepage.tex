...
%%%% Что
%%%%
\Ttitle{Обзор методов комплексного ассоциативного поиска видео}

\vspace{24pt}

\Ttitle{An Overview Of Complex \\Content-Based Video Retrieval Methods}
...
{ \small \begin{flushright}
        \begin{tabular}{rl}
            ...
            Автор: 				& \byhand{И.\,К. Никитин <w@w-495.ru>}	\\
                                &	\\
