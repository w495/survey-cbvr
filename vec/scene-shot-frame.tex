...
\begin{document}
    ...
    \begin{tikzpicture}[very thick,node distance=8em]
        ...
        \begin{pgfonlayer}{background}
            \node[videof,label={\Large Видео}] (video) {};

            \node[scenef,label={[xshift=8em]\Large Сцены},
                below of=video, xshift=-8em] (scene1) {};
            \node[scenef, right of=scene1, xshift=8em] (scene2) {};

            \node[shotf,label={[xshift=12em]\Large Съёмки},
            ...
            \node[frame1f,label={[xshift=15em]\Large Ключевые кадры},
